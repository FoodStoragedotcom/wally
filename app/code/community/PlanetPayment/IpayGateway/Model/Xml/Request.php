    ...
    public function generateRequestForPycAuth() {
        try {
            ...
            if ($profile->getAccountId()) {
                ...
                $fields->addChild('ADDRESS', $billingAddress->getStreet());
                $fields->addChild('CITY', $billingAddress->getCity());
                $fields->addChild('POSTAL_CODE', $billingAddress->getPostcode());
            }
    ...
    public function generateNewWalletProfileRequest() {
        try {
            ...
            if ($profile) {
                ...
                $fields->addChild('ADDRESS', htmlentities($profile->getAddress(), ENT_QUOTES));
                $fields->addChild('CITY', htmlentities($profile->getCity(), ENT_QUOTES));
                $fields->addChild('POSTAL_CODE', htmlentities($profile->getZip(), ENT_QUOTES));
